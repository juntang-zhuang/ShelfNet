...
class VOCSegmentation(BaseDataset):
    ...
    def __init__(self, root=os.path.expanduser('~/.encoding/data'), split='train', mode=None, transform=None,
        ...
        self.return_file = return_file # if set as true, return file names
    ...
    def __getitem__(self, index):
        ...
        # return file names if in val mode
        if self.mode == 'val' and self.return_file:
            return self.transform(img), self.totensor(target), os.path.basename(self.images[index])
